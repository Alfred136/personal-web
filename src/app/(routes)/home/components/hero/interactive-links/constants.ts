...
const BLOCK_1_DROP_ANIMATION_DURATION_MS: number = 800;
const BLOCK_2_DROP_ANIMATION_DURATION_MS: number = 600;
const BLOCK_3_DROP_ANIMATION_DURATION_MS: number = 900;
...
export {
  ...
  LINKEDIN_IMAGE_SRC,
  LINKEDIN_IMAGE_ALT,
  BLOCK_1_DROP_ANIMATION_DURATION_MS,
  BLOCK_2_DROP_ANIMATION_DURATION_MS,
  BLOCK_3_DROP_ANIMATION_DURATION_MS
};
